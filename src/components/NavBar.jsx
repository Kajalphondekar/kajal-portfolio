  ...
  return (
    <>
      <Navbar expand="lg" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="#home">Kajal phondekar</Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <span className="social-icons">
                {/* Github */}
                <a href="https://github.com/kajalphondekar">
                  <i class="bi bi-github"></i>
                </a>
                {/* LinkedIn */}
                <a href="https://in.linkedin.com/in/kajal-phondekar-493771217">
                  <i class="bi bi-linkedin"></i>
                </a>
                {/* Instagram */}
                <a href="https://instagram.com/i_am_kajal2306">
